...
import styles from './SendOrderRequest.module.scss'
import {Checkbox, ImagesPreview, Input, SimpleUploader, Textarea} from '@UI'
import useSendOrderRequestPopUp from '@components/UI/PopUp/PopUps/SendOrderRequest/useSendOrderRequestPopUp'
import {LinkMarkdown} from '@appComponents'


export const SendOrderRequest: FC = () => {
        ...
        >
            ...
            >
                ...
                <div
                    id='additionalInfo'
                >
                    <span>{popUpData.additionalInfo.label}{popUpData.additionalInfo.label && popUpData.additionalInfo.required && '*'}</span>
                    <Textarea
                        id='additionalInfo-input'
                        placeholder={popUpData.additionalInfo.placeholder || ''}
                        value={additionalInfo}
                        onChange={inputChange('additionalInfo') as ChangeEventHandler<HTMLTextAreaElement>}
                    />
                </div>
                <div
                    id='uploader'
